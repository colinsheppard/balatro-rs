...
mod tests {
    ...
    fn test_config_new() {
        ...
        assert_eq!(config.store_consumable_slots_max, DEFAULT_STORE_CONSUMABLE_SLOTS_MAX);
    ...
    fn test_config_default() {
        ...
        assert_eq!(config.store_consumable_slots_max, new_config.store_consumable_slots_max);
    ...
    fn test_serialization() {
        ...
        let deserialized: Config = serde_json::from_str(&json).expect("Should deserialize from JSON");
