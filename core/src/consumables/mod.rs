...
pub enum ConsumableId {
    ...
    Incantation,
    /// The Soul - Creates a Legendary Joker (special properties: not generated by joker effects, Ghost Deck exclusion)
    TheSoul,
    /// Black Hole - Upgrades all poker hands by 1 level each (special properties: not generated by joker effects, Ghost Deck exclusion)
    BlackHole,
